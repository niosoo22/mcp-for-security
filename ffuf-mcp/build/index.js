...
server.tool("do-ffuf", "Run ffuf with specified URL", {
    url: zod_1.z.string().url().describe("Target URL to fuzz"),
    ffuf_args: zod_1.z.array(zod_1.z.string()).describe(`Additional ffuf arguments 
 HTTP OPTIONS:
...
OUTPUT OPTIONS:
  ...
  -or                 Don't create the output file if we don't have results (default: false)
    ...
    const ffuf = (0, child_process_1.spawn)(args[0], ['-u', url, ...ffuf_args]);
    let output = '';
    // Handle stdout
